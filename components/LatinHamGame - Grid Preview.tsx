...
const PreviewCell: React.FC<{ value: number }> = ({ value }) => {
  ...
  return (
    <div className={`w-6 h-6 ${colorClass} border border-gray-300 rounded-sm`}></div>
  )
}
...
const GamePreview: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-6 gap-1 bg-gray-200 p-2 rounded-lg shadow-inner mb-8">
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        ...
        <div className="w-[calc(6*3rem+6*0.75rem)]">
          <h1 className="text-6xl font-bold mb-4 text-center">36latinHam</h1>
